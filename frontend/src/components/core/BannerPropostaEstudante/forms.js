    ...
    <div>
      <Row className="proposta__registrar">
        <Col style={{ display: "flex", flexDirection: "column" }}>
          <span className="icon">
            <AiOutlineMail color="#ffffff" size="1.25em" />
          </span>
          <label>E-mail</label>
          <input
  ...
  return (
    <div>
      <div className="input-icon">
        <span className="icon">
          <BsPerson color="#ffffff" size="1.5em" />
        </span>
        <div className="form-group">
          <label className="control-label" for="candidate_name_1">
            Nome completo (mín. 5 caracteres)
          </label>
          <input
      ...
      <div className="input-icon">
        <span className="icon">
          <BiUserCheck color="#ffffff" size="1.5em" />
        </span>
        <div className="form-group">
          ...
          <input
            ...
            type="text"
            onChange={callBack("username")}
          />
        </div>
      </div>
      <div className="input-icon">
        <span className="icon">
          <BsLock color="#ffffff" size="1.5em" />
        </span>
        <div className="form-group">
          <label className="control-label" for="candidate_name_1">
          ...
          <div className="address-container">
            <span>
              ...
              <input
                ...
                placeholder="Rua"
                type="text"
                onChange={callBack("address_street")}
              />
            </span>
            <span>
              <a>Número</a>
              <input
                ...
                placeholder="Numero"
                type="text"
                onChange={callBack("address_number")}
              />
            </span>
            <span>
              <a>CEP</a>
          ...
          <div className="region-container">
            <span>
              ...
              <input
                ...
                placeholder="Cidade"
                type="text"
                onChange={callBack("address_city")}
              />
            </span>
            <span>
              <a>Pais</a>
              <input
                ...
                placeholder="Pais"
                type="text"
                onChange={callBack("address_country")}
              />
            </span>
          </div>
          <div className="input-icon" style={{ paddingTop: "15px" }}>
            <span className="icon">
              <RiCellphoneFill color="#ffffff" size="1.5em" />
            </span>
            <div className="form-group">
...
const Form_4 = ({ ...props }) => {
  ...
  return (
    <div>
      <div className="input-icon">
        <span className="icon">
          <AiFillGithub color="#ffffff" size="1.5em" />
        </span>
        <div className="form-group">
          <label className="control-label" for="candidate_name_1">
            GitHub
          ...
          <input
            ...
            type="text"
            onChange={callBack("website")}
          />
        </div>
      </div>
      <div className="input-icon">
        <span className="icon">
          <FaIndustry color="#ffffff" size="1.5em" />
        </span>
        <div className="form-group">
      ...
      <div className="input-icon">
        <div className="form-group">
          ...
          <input
            ...
            id="icon"
            placeholder="Nos conte de você"
            type="text"
            onChange={callBack("about")}
          />
        </div>
      </div>
      <input
