    ...
    const user = {
      ...
      address:
        values.address_street +
          ...
          values.address_city +
          "," +
          values.address_country || undefined,
      ...
      <Container style={{ marginLeft: 96.58 }}>
        <Row>
          ...
          <Col lg={{ span: 6 }}>
            ...
            <ul>
              <li>
                <GiSkills color="#FFCF26" style={{ marginRight: "1em" }} />{" "}
                Aprenda as skills mais requisitadas do mercado
              </li>
              <li>
                ...
                />{" "}
                90% dos candidatos(as) recebem convites para entrevistas
              </li>
              <li>
                <AiFillStar color="#FFCF26" style={{ marginRight: "1em" }} />{" "}
                Sinalize seu valor para as empresas parceiras
              </li>
            </ul>
            <div>
              {form === "Form_1" && (
